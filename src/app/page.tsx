...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 rounded-bl-full rounded-l-md	">
     <div><figure className="md:flex bg-lime-400 rounded-xl p-8 md:p-0 dark:bg-slate-800">
